            ...
            <React.Fragment key={msg.id}>
              ...
              >
                ...
                <motion.div
                  ...
                  className={`group relative flex-1 flex flex-col ${isMe ? "items-end" : "items-start"} ${
                ...
                >
                  ...
                  <AnimatePresence>
                    {!isSelectionMode && hoveredMessageId === msg.id && (
                      <motion.div
                        initial={{ opacity: 0, y: 4, scale: 0.9 }}
                        animate={{ opacity: 1, y: 0, scale: 1 }}
                        exit={{ opacity: 0, scale: 0.9 }}
                        transition={{ duration: 0.12 }}
                        className={`absolute -top-7 ${isMe ? "right-2" : "left-2"} z-20 flex items-center gap-1 p-1 rounded-full bg-white dark:bg-[#182229] border border-slate-200 dark:border-slate-700 shadow-lg backdrop-blur-md`}
                      >
                  ...
                  >
                    ...
                    {msg.reactions && Object.keys(msg.reactions).length > 0 && (
                      <div className={`absolute -bottom-2.5 ${isMe ? "right-2" : "left-2"} flex items-center gap-0.5 bg-white dark:bg-[#182229] border border-slate-200 dark:border-slate-700 rounded-full px-1.5 py-0.2 shadow-sm text-[11px]`}>
