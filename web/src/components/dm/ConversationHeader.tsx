      ...
      <header className="h-16 shrink-0 border-b border-slate-200/80 dark:border-slate-800/80 bg-white/95 dark:bg-[#111b21]/95 backdrop-blur-xl px-3 sm:px-5 flex items-center justify-between gap-2 z-30 transition-colors">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3 overflow-hidden min-w-0">
          ...
          >
            ...
            <div className="relative shrink-0">
              <div className="flex h-10 w-10 items-center justify-center rounded-2xl overflow-hidden bg-[#1E90FF] text-white font-bold text-xs shadow-sm ring-1 ring-white/20 relative">
                <span className="select-none">{getInitials(peer.name || "Classmate")}</span>
                {peer.avatar && (
                  <img
                    src={peer.avatar}
                    alt={peer.name || "User"}
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          <button
            ...
            className="p-2 rounded-xl text-slate-500 dark:text-slate-300 hover:text-amber-500 dark:hover:text-amber-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
